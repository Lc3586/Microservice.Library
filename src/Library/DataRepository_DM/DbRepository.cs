...
namespace Microservice.Library.DataRepository_DM
{
    public class DbRepository : IRepository
    {
        ...
        /// 数据库类型
        /// </summary>
        public DatabaseType DbType { get { return DatabaseType.OdbcDameng; } }
        ...
        {
            using (DmConnection conn = new DmConnection())
            {
                ...
                DmBulkCopy sqlBC = new DmBulkCopy(conn)
                {
                    BatchSize = 100000,
                    BulkCopyTimeout = 0,
        ...
        {
            DbProviderFactory dbProviderFactory = DmClientFactory.Instance;
