...
namespace Microservice.Library.BloomFilter
{
    ...
    public class ShareMenmory<T>
    {
        ...
        public string GetUrl(int index)
        {
            ...
            return Encoding.UTF8.GetString(Read(200, offset)).Trim();
        }
        ...
        {
            int offset = 1 + index * (entityLength + 1) + 8;
            Write(Encoding.Default.GetBytes(url), offset);
        }
        ...
        public string GetState(int index)
        {
            ...
            return Encoding.UTF8.GetString(Read(1, offset)).Trim();
        }
        ...
        {
            int offset = 1 + index * (entityLength + 1) + entityLength - 2;
            Write(Encoding.Default.GetBytes(state.ToString()), offset);
        }
        ...
        public void SetEntity(int index, T t)
        {
            ...
            Write(Encoding.Default.GetBytes(JsonConvert.SerializeObject(t)), offset);
        }

        public T GetEntity(int index)
        {
            string str = Encoding.UTF8.GetString(Read(entityLength, index * entityLength));
