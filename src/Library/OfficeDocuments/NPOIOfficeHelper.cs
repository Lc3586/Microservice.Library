...
namespace Library.OfficeDocuments
{
    ...
    public class NPOIOfficeHelper
    {
        ...
        public static byte[] DataTableToExcelBytes(DataTable dt, bool firstRowIsTitle = true, bool xslx = true)
        {
        ...
        /// <param name="firstRowIsTitle">第一行是否为标题</param>
        /// <returns></returns>
        public static DataTable ReadSheet(ISheet sheet, bool firstRowIsTitle = true)
        {
        ...
        /// <param name="firstRowIsTitle">第一行是否为标题</param>
        /// <returns></returns>
        public static DataTable ReadExcel(string fileNmae, bool firstRowIsTitle = true)
        {
        ...
        /// <returns></returns>
        public static DataTable ReadExcel(byte[] fileBytes, bool firstRowIsTitle = true, bool xslx = true)
        {
        ...
        /// <param name="xslx">是否为xslx文件</param>
        /// <returns></returns>
        public static DataTable ReadExcel(Stream stream, bool firstRowIsTitle = true, bool xslx = true)
        {
            var workbook = xslx
