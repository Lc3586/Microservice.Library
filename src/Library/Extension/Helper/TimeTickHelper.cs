...
namespace Microservice.Library.Extension.Helper
{
    ...
    /// LCTR 2019-08-27
    /// </summary>
    public class TimeTickHelper
    {
        public TimeTickHelper()
        {

        }

        public TimeTickHelper(TimeSpan dely, TimeSpan timeSpan)
        {
            _dely = dely;
            _timeSpan = timeSpan;
        }
        ...
        private readonly Dictionary<object, Timer> timeTick = new Dictionary<object, Timer>();
