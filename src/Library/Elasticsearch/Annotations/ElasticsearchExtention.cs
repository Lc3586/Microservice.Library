...
namespace Library.Elasticsearch.Annotations
{
    public static class ElasticsearchExtention
    {
        ...
        {
            var attributes_Indices = type.GetCustomAttributes(typeof(ElasticsearchIndiceExtentionAttribute), true);
            if (attributes_Indices == null || attributes_Indices.Length == 0)
                return null;
            return (attributes_Indices[0] as ElasticsearchIndiceExtentionAttribute).Version;
        }
        ...
        public static string GetIndicesName(this Type type, DateTime? state = null, string all = null)
        {
            ...
            if (attributes_Indices != null && attributes_Indices.Length > 0)
            {
                var sub_type = (attributes_Indices[0] as ElasticsearchIndiceExtentionAttribute).IndicesSubType;
        ...
        public static bool IsAutoCreate(this Type type)
        {
            ...
            if (attributes_Indices == null || attributes_Indices.Length == 0)
                return false;
            return (attributes_Indices[0] as ElasticsearchIndiceExtentionAttribute).AutoCreate;
        }
        ...
        public static bool IsAutoUpdateSetting(this Type type)
        {
            ...
            if (attributes_Indices == null || attributes_Indices.Length == 0)
                return false;
            return (attributes_Indices[0] as ElasticsearchIndiceExtentionAttribute).AutoUpdateSetting;
        }
        ...
        public static bool IsDynamic(this Type type)
        {
            ...
            if (attributes_Indices == null || attributes_Indices.Length == 0)
                return false;
            return (attributes_Indices[0] as ElasticsearchIndiceExtentionAttribute).Dynamic;
        }
    }
}
