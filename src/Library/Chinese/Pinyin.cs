...
namespace Microservice.Library.Chinese
{
    ...
    public class Pinyin
    {
        ...
        public static List<string> GetPinyin(string str, string None = null, bool RemovePS = false, bool JustFirst = false, bool Upper = false, bool Lower = false)
        {
        ...
        /// <returns></returns>
        public static bool CheckStringChineseReg(string str)
        {
