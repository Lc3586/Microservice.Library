...
namespace Entity.Example
{
    ...
    [OraclePrimaryKeyName("pk_" + nameof(Sample_DB_D))]
    //[System.ComponentModel.DataAnnotations.Schema.Table(nameof(Example_DB_D))]//特别指定数据库表名
    #region 设置索引
    [Index(nameof(Sample_DB_D) + "_idx_" + nameof(Name), nameof(Name) + " ASC")]
    [Index(nameof(Sample_DB_D) + "_idx_" + nameof(CreatorId), nameof(CreatorId) + " ASC")]
    [Index(nameof(Sample_DB_D) + "_idx_" + nameof(CreatorName), nameof(CreatorName) + " ASC")]
    [Index(nameof(Sample_DB_D) + "_idx_" + nameof(CreateTime), nameof(CreateTime) + " DESC")]
    #endregion
