...
namespace Integrate_Api
{
    ...
    public class BaseController : ControllerBase
    {
        ...
        {
            return base.Content(obj.ToJson<TOpenApiSchema>(), "application/json", Encoding.UTF8);
        }
        ...
        /// <returns></returns>
        protected ContentResult JsonContent<TOpenApiSchema>(TOpenApiSchema obj, Pagination pagination, bool success = true, string error = null)
        {
            return base.Content(pagination.BuildResult(obj.ToJson<TOpenApiSchema>(), success, error).ToJson(), "application/json", Encoding.UTF8);
        }
